...
## CH4 — the Challenger · goes after `ch4:708`
...
## CH5 — the Regent · goes after `ch5:613`
...
**Direct Action — the inheritance claimed to the people who hold it with you**
...
**Raise Awareness — the reason said out loud while somebody still knows it**
...
**Gather Resources — the hours asked for so one body stops being the structure**
...
**Skillful Organizing — the practice a group can run with the keeper gone**
...
## CH6 — the Architect · goes after `ch6:530`
...
**Raise Awareness — the load-bearing assumption said out loud at the table built on it**
...
**Gather Resources — the cost moved off a person and into the budget**
...
## CH7 — the Diplomat · goes after `ch7:692`
...
**Raise Awareness — the cost of the arrangement named where it gets set**
...
**Gather Resources — what your staying requires, asked for while somebody can still grant it**
...
**Skillful Organizing — the agreement a group has been running without**
...
## CH8 — the Sage · goes after `ch8:683`
...
**Raise Awareness — the real agenda said out loud at the table running it**
...
**Gather Resources — the specific help asked for where the framework was easier**
