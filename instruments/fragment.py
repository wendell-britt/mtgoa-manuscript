...
EXTRA_VERBS = set("""ought shall must lest conducts date steers 'm 're 've 'll 'd""".split())
...
def main():
    ...
    print("EDITORIAL fragment unresolved=%d accepted=%d total=%d target=0" % (total - acc, acc, total))
