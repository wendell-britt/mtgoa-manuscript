...
- Is a facilitat### Pass 7 — ICA Reader Review (continued)
...
3. **Felt-Sense Tracker reader:** Who does the cold read? Wendell exclusively, or can it be delegated? **Recommendation:** Wendell does Ch0-Ch4. Delegate Ch5-Ch8 after a training pass where Wendell validates the reader can reliably flag the right issues.
