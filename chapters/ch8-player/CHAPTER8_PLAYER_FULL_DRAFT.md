...
The Player left on purpose. Not because the village was wrong. Not because they were rejected. They left because they had learned everything the village could teach them and there was something specific they wanted to build that required going further out than the village extended.
...
And when the village asked *what now?* the Player said: *I'm going to build something.*

Not a reaction. Not a protest. Not a critique of what the village was doing wrong. The Player had learned all the Faces. The Player had run the WAVE. The Player knew how to feel, how to draw lines, how to build, how to design, how to hold the field, how to see. And now the Player was going to make something new.
...
This is the distortion. And it crept in slowly, the way most distortions do—not as a lie, but as an understandable mistake.
...
You have been the Shaman. You know how to feel what's true in a room, name it without destroying it, let the feeling complete its cycle before you act on it.
...
The six Faces are your toolkit. The WAVE is your process. The altar—the practice of returning—is your anchor. And now you get to design your specific practice: the combination of all six that is uniquely yours, grounded in your specific survival, your specific superpowers, your specific village.
...
That's the only definition that matters. Not what you believe about allyship. Not what you intend to do when you're calm. What you do when you're activated — when your mother calls, when the group chat erupts, when someone says something that lands wrong and you have to decide in real time whether to say something or stay quiet. The practice is the thing you do when it costs you something to do it.

This book has been teaching you what to do in those moments. The WAVE. The six Faces. The emotional channels. These aren't concepts to understand — they're moves to make. And like any moves, they require practice. Not theory. Practice.
...
The practice has five stages. They're not sequential in the way the WAVE's stages are—they loop. You return to them. But each pass through, you go a little deeper.
...
The Founder starts something new. Not a nonprofit. Not a brand. Not a platform. The Founder creates the thing that didn't exist before — the specific allyship practice that this book only points toward.

The practice: Name it. Give it a name that is specific to you, specific to your village, specific to the problem you are trying to solve. The name doesn't have to be public. But it has to be real. *This is the thing I'm building. This is the game I'm playing.*
...
4. **Build:** Start something. Say something. Create the thing that didn't exist before you.
...
Here's what I've noticed about my own arrival at this work: I came to it the way most people come to it. I saw something that was wrong. I felt the discomfort of witnessing harm I couldn't fix. And I did what the culture taught me to do — I looked outward for the solution. I learned the vocabulary. I updated my positions. I performed the correct responses. And the discomfort didn't go away. It got worse. Because I was treating symptoms with the same kind of thinking that produced them.

The shift happened when I stopped asking *what should I do* and started asking *what is actually happening inside me when I see this.* That's the Shaman's move. Not fixing the outward problem. Feeling what's true. Naming what's actually there. And staying with it long enough to let it complete its cycle before acting.
...
You now know the WAVE. Wake up. Clean up. Grow up. Show up. And come back.
...
You know that the five emotional channels are not just vocabulary — they are a map of the territory you've been avoiding. Fear, anger, sadness, joy, neutrality: each one a gate you can walk through instead of a threat to manage.
...
That's what the map is silent about. And I want you to know it — so that when the walking takes longer than you thought, you don't read that as evidence that you took the wrong path.
...
This is what the WAVE already taught you. Wake up — notice what happened. Clean up — name what didn't work. Grow up — ask what the failure is actually telling you. Show up — do the next version. Come back — notice what shifted. What you learned.
...
My WAVE runs through the writing of this book. I wake up to what's actually happening in a chapter — not what I want to be happening, but what's actually there. I clean up the places where I'm performing instead of saying what's true. I grow up into the harder version of the idea I was avoiding. I show up to the page. I come back and notice that the chapter that was blocking me for three days unclogged the moment I stopped forcing it and let the Shaman name what was actually there.

The walk also means walking into the specific problem that you are trying to solve.

You didn't come to this book with a general question. You came with a specific ache. Something in your life, your work, your family, your community — some specific gap where the allyship you were performing wasn't working and you knew it. Maybe it was a relationship where you kept doing the right thing and feeling nothing. Maybe it was a community where you were the designated ally and it was destroying you. Maybe it was a public issue — the election, the pandemic, the ongoing catastrophe — where you felt morally obligated to act and emotionally unable to act and intellectually confused about what action even meant anymore.
...
When you're ready, there is a place to go. Bars-engine is the village's common ground — the playground where players arrive after finishing the book, where the allyship work becomes real. Campaigns. Quests. Allyship programs run through the non-profit. A structure that was already being built before you got here, and that has room for what you're going to add. You don't have to build bars-engine from scratch. You don't have to build the infrastructure alone. You bring your specific gift. The structure plugs in around it. The village is already there, doing the work, and what you make fits into what they're doing.

This is what walking into the specific problem looks like when you're ready: not figuring out how to start from nothing, but finding where you fit in something that's already alive. The game is bigger than any one person. That's the point. That's the gift.
...
Not everyone finishes this book knowing exactly what they're building. Some of you are still in the middle of the walk — still in the confusion, still in the iteration, still redesigning the same mechanic for the third time. Some of you don't have a Founder move yet. You came to the work, you learned the Faces, you ran the WAVE, and you're still asking: *but what is mine?*

I want to name that directly, because the book would be doing you a disservice if it pretended everyone leaves Chapter 8 with a fully-formed game.

You might be a Cartographer who hasn't become a Founder yet. That's not a failure — that's the stage you're in. The Cartographer's job is to keep mapping until the terrain reveals what needs to be built. You don't force the Founder move before it's ready. You keep the inventory honest. You keep noticing what gap keeps showing up. And when the problem becomes specific enough — when you've mapped it enough times that you can name it in a sentence — the Founder move will become obvious.
...
*I don't start things. I'm not an entrepreneur. I don't have a business in me. I'm a helper, a teacher, a parent, a friend — not a founder.*

I hear that. And I want to name what's actually happening with that resistance.
...
Here's the thing the culture doesn't tell you: you have already done this. You have already made something that didn't exist before you. A tradition in your family that wasn't there before. A conversation you had differently than your parents would have had. A way of being with your kids that broke a pattern. A community you helped start by being the person who brought people together.

You have already been the Founder. You just didn't call it that.
...
That's all it takes. You don't have to build bars-engine. You don't have to start a nonprofit. You don't have to have a platform or an audience or funding. You just have to decide that the problem you're carrying is worth solving — and start making something toward it. The scale doesn't matter. The specificity does.

---

The walk includes failure. Not as a lesson about resilience. As an actual thing that happens.

Some things you build will fail. Not everything works. Not everything lands. Not everything survives contact with the village. You will make something and present it and find that the village wasn't ready for it — that what you built as liberation they experienced as threat. That's not a failure of character. That's the Outlaw's cost. The village often resists the new game until it doesn't, and the period of resistance is part of the walk.

Some failures are just failures. The design was wrong. The timing was wrong. The thing you built didn't solve the problem you thought it would solve. That's data. The Player doesn't treat failure as defeat. The Player treats failure as the WAVE — wake up to what actually happened, clean up what didn't work, grow up into the next version, show up.
...
The village is not just the people who will receive what you build. The village is the people who are already building. bars-engine is not a solo project — it's a structure that was already alive before you finished this book. Campaigns are running. Quests are active. Players are showing up. And there is room for what you're going to add.

You don't have to figure out how to start from nothing. You don't have to build the whole thing yourself. You bring your specific gift — the thing this book helped you name, the thing you figured out how to do by walking your own terrain. Other people are bringing theirs. The game is bigger than any one person.
...
You have been through the Shaman's Forest, the Challenger's Battle Lines, the Regent's Legacy, the Architect's Blueprint, the Diplomat's Field, the Sage's Panoramic View. You have named your exile and faced your shadow. You have mapped your terrain and found your gift.
...
### *Five Moves the Player Plays*

The Player's game is the game that didn't exist before. The game designed by the Player, for the Player, in service of the village they want to leave behind.

**1. Map Your Terrain**

Before you play, map. Which Faces are you? Which Faces do you avoid? What is your specific gift? What is your specific gap? The Cartographer's move: honest self-inventory, no judgment.

**2. Name Your Problem**

What problem in the world are you trying to solve? What made you? What keeps you up at night that you wish you could fix? The Player's move: naming the specific problem that your allyship practice is designed to solve. Not a general problem. A specific one.

**3. Design Your Practice**

Build the specific blend of all six Faces that is yours. Write it down. Make it concrete. The Designer's move: using the toolkit to create something that fits your specific terrain.

**4. Start Something**

Create the thing that doesn't exist. Say the thing that hasn't been said. Write the thing that needs to be written. Build the thing that needs to be built. The Founder's move: making something real out of what you've learned.

**5. Make It Pass-Onable**

Design it so someone else can run it without you. The goal is not dependence—it is inheritance. The Elder's move: handing on what you learned so the next person can walk the same path without repeating your mistakes.

---

**The 5 moves are not the practice. They are the map of the practice.**
...
Here's what I've noticed about my own mistake with this: I spent months with the 5 moves in front of me — reviewing, discerning, designing, building, passing on — without actually doing any of them. I thought I was practicing. I was planning. I was preparing. I had the vocabulary for what I was supposed to be doing, which made it feel like I was already doing it. It wasn't until I actually started something — before I felt ready, before the design was complete — that the practice became real.

The practice is not the list. The practice is the loop. Running it. Messing it up. Running it again. Running it with someone else watching. Running it when it fails. Running it the next day. That's the practice. And the 5 moves are just the map that tells you where to walk.

---

Bars-engine is a Player's game. It uses all five moves. *Map Your Terrain* — it started from an honest inventory of what didn't exist in the allyship practice landscape. *Name Your Problem* — it solves the gap between knowing and doing, between understanding the WAVE and actually running it. *Design Your Practice* — it is the design, the thing itself, not a description of a thing. *Start Something* — it exists. People play it. Outcomes happen. *Make It Pass-Onable* — the game hands off to whoever runs it next. The goal is for bars-engine to outlive its founder, which means designing it so the structure doesn't need me in the room.
...
Don't wait. Try the sequence on something small, something that doesn't require permission or resources or anyone else's involvement.

*Name Your Problem.* Right now. What's the thing in your life that keeps showing up — the one you keep trying to fix with the same moves that never work? Write it down in one sentence. That's your problem.

*Name the Face you keep avoiding.* Don't analyze it. Don't judge it. Just notice: which of the six have you been performing without actually being? Which one have you been told is not your style?

Now: *Design Your Practice* — one sentence. Not a philosophy. A move. *When this problem shows up, I will do X instead of doing what I always do.*

That's it. Sixty seconds. You've just run the sequence.
...
Before the recap, one design, one doing. Within seven days.

The Player's game is the designed practice. The whole chapter has been saying it: *the move you can describe in one sentence, the move that fits in a moment, the move you can do without permission*. The "Sixty Seconds" beat at the close of Section 6 is the design -- *When this problem shows up, I will do X instead of what I always do.* That is the first half. The second half is the next sixty seconds after the design, when the moment actually shows up, and you have to either do the move or do the old thing. The design is free. The doing is the move.

Pick the situation. The one that has been coming back. Pick the move. The single sentence. Say it out loud, write it down, set the alarm, do the thing that makes the move remember itself. Then, within seven days, let the situation come back. Do the move. Sixty seconds. You are not asked to be good at it. You are asked to do it.

The test. **Reading one:** you designed the move, the situation showed up, you did the move, and the next time the situation comes back, *the move is the path of least resistance*. **Reading two:** you designed the move beautifully, the situation did not show up in the seven-day window, you felt the relief of having designed without having been tested, and the move is still a design. The Player's whole game is the design meeting the moment. The shadow is the design kept offstage.
...
1. Which of the six Faces feels most like you? Which feels least like you? Where is your specific gift?

2. What problem in the world are you trying to solve? What made you necessary?

3. If you could design one practice—one specific thing you do regularly—that is uniquely yours and addresses your specific problem, what would it be?

4. Who is behind you that needs what you've learned? How would you translate it for them?

5. What game do you want to play that doesn't exist yet?

---

## The Last Line

The book ends here. Not with a summary. Not with a checklist.
