...
Where to go and run it, not a substitute for having run it. Each entry ends with the
chapter and section that teaches the term.
...
**Clean no, the** — Stating a boundary without apologizing for it, collapsing it, or
converting it into a request. Three parts: the line, the delivery, the cost. *Ch 4 §3*
...
**Emotional Body, the** — The daemon where feeling gets processed into meaning. Run clean it
becomes information; stuck, it spills sideways. *Ch 2 §6*

**Exile, the** — Why each Face left the village, and what the village lost when it went. Every
chapter opens with one. *Ch 3 §1, and once per chapter*

**Face, the six** — Shaman, Challenger, Regent, Architect, Diplomat, Sage. Six Game Masters,
...
**Forest, the** — The inner landscape where the daemons wait and the work actually happens.
...
**Regent, the** — The Face that keeps what works and hands it on. Means: somebody carried the
...
the unsaid charge, said out loud, landed. *Ch 3*
