...
curriculum.*""",
5: """*Sera hands new students something inherited — a role, a ledger, a duty nobody wants — and
...
6: """*Irix asks every student to draw the system and then asks whose face disappeared from the
...
("### The Five-Move Form", """*Maera says you can make one pass through the Five-Move Form in ten seconds. She is right, and she has been practising for
thirty years.*
...
NOTES[5] = [
("still moving because nobody noticed", """*Halvane has both kinds. They mend everything and let the mend show — a replaced roof beam is
...
you have.*"""),
("### The Inheritance Cycle", """*The school keeps a vow ceremony that nobody can explain. It runs forty minutes. Two of the six
...
("They see somebody who is fast", """*They see somebody who is fast. I was somebody who was fast.*
