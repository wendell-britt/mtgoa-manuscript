# 15 — The Head Voice Dial

**2026-07-30. Wendell: "I do think I want to create a spec that nails down the genre and
style of each of the headmasters. They don't quite feel alive yet and I can't put my finger
on it… They use the same handbook format. Their answers are different and their tone and
area of concern are different. We need to exaggerate it in a way that preserves the essence.
we are close I think 2 more passes in this way should get us there, and unless it gets worse
we'll keep what we get."**

Sits under `SEVEN_VOICES.md` (genre) and `HEAD_REGISTERS.md` (what they do with feeling).
This is the third layer: **how far to push, and how to tell whether a pass made it worse.**

---

## 1 · The diagnosis — why correct-to-genre still reads dead

Four facts were drafted correctly to genre and still read as exhibits. The reason is in
`HEAD_REGISTERS` and I had already quoted it without applying it:

> **"The satisfaction is offered, not achieved. A Head who has completed their own move has
> nothing left to teach."**

**Every draft completed the move.** Voss gets the sensitivity back. Quill's replacement
practice is running. Vale asks and learns. Orr has stopped waiting. Each is a finished
anecdote with the bill paid, and a paid bill is a display case.
...
Genre gives form. Form is not personality. These six are what make a form sound like a
person, and each is exaggerated one click past comfortable.

| dial | what it is | why it makes a voice alive |
|---|---|---|
| **The tic** | a verbal habit, at a stated frequency | recognisable within two sentences, which is the Cloud Atlas test `SEVEN_VOICES` sets |
| **The irritation** | the thing they cannot let pass without a remark | annoyance is the cheapest evidence of a real interior |
...
### Maera Voss · School of the Body · a practitioner's casebook
- **Tic** — sensation before concept, always, no exceptions: *Jaw. Then: the table had decided.* Twice per page minimum.
- **Irritation** — people who report a feeling in the past tense. She will correct the tense.
...
- **Irritation** — qualifiers. Counts them out loud.
...
- **Irritation** — the practice as kept diverging from the practice as written without anybody recording the divergence.
...
- **Irritation** — anyone who calls a design failure a compliance problem.
...
- **Irritation** — being thanked, which he receives badly.
...
- **Irritation** — being asked to arbitrate between two schools.
...
- **Not more adjectives.** Every dial above is a behaviour or a structure.
- **Not more backstory.** The one-fact rule is lifted, but a fact still earns its place by
  answering a question the form asks. Three facts is a novel and `PRODUCTION_PLAN` bans it.
- **Not breaking rule 1 of `HEAD_REGISTERS`.** No Head names a channel, a feeling-word, or an
  operation. Chapter 3 owns that vocabulary and exaggeration does not buy an exemption.
- **Not comedy for five of them.** Orr is the only Head funny on purpose. The others can be
  funny by accident, which is a different and usually better thing.
