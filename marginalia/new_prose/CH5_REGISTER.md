# ch5 · the register of discontinued practices

**2026-07-30.** Wendell: *"I think we should move it below the seam and replace it with
structures that are generic that quill has seen across the cosmos. Gives a parallel structure
and sets up the biographical experience."*

What leaves: 330 words of his memoir standing above Quill's signature — martial arts, the
church, the collective with no governance, the crown under the hood. It goes to the head of
his Section 4, where Section 4's opening question (*what did you inherit?*) is the question
it answers.

What arrives in its place: the same eight beats, in Quill's charter. Written to
`HEAD_VOICE_DIAL.md` §2a — third impersonal, no *you*, fact and record, feeling entered only
as a ledger entry — and to her ruled tic, which is that every claim gets a clause number and
the note is where she says the true thing. Merrow is overruled once, which is the dial.

**The parallel, beat for beat.** This is the whole reason the swap works rather than merely
clears the membrane:
...
| first crisis adapted, second circled, third with no memory | the same three, entered as typical and stable |
| never figured out how to offer the floor before the crisis | clause six, which she would amend and cannot |

The general case is stated first by somebody who has counted, and then the reader meets the
one man it happened to. That order is what makes the memoir evidence rather than anecdote.
