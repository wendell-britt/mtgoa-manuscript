# The Headmaster's Letter, draft 1

**2026-07-31.** Wendell's three rulings on the brainstorm:

1. My *six near-identical pages* worry is dropped. He is right that the conclusion was thin.
2. **ch1's unkept loop promise gets fixed**, and this letter is what keeps it. `ch1:193` says
   *"the loop you meet in the next chapter"*; ch2 has no loop section. The letter prints the
   loop, so the pointer moves to the letter and the promise is kept one page before the
   schools rather than never.
3. **The letter may describe the loop, and the Faces are expressions of depth.** His words:
   *"They connect to the integral levels. We call them Faces so that we don't cause a depth
   allergy from the diplomat, but it's already taken care of, we just need to talk about this
   translation in terms of the game world."*

---

## What ruling 3 changes about the audit

`AUDIT_GAME_LOOP_CONFORMANCE` scored **Depth absent, 0 hits**, and called it the largest
structural hole in the book. That grep was looking for a scope-choice mechanism and there
isn't one. But the vertical axis it was really looking for has been in the book since ch1
under a different name, six times over, and the audit missed it because it was searching for
the word.

So the finding splits in two, and only half of it is a hole:

| | state | who supplies it |
|---|---|---|
| **which capacity you are working from** — the vertical | **present, and load-bearing** | the six Faces, and the six schools' entry requirements, which run in chapter order |
| **how much of it you take on this pass** — the scale | **still absent** | nothing. This is the dial the letter has to add |

The letter delivers both in one act, because enrolling is choosing a school *and* choosing how
much of a term to take. That is not a metaphor for Depth. It is Depth, wearing the fixture the
book already built.

## The ch8 collision, and how the letter stays clear of it

ch8 runs an explicit *anti*-mapping that the letter must not contradict. Its Polarity
Encounter is **Which Game ↔ Which Altitude**, and it rules them two different reads:

> *Which altitude is this?* is a vertical question. Red, Amber, Orange, Green, Teal. It asks
> what a person can currently hold — the size of the frame they operate from, a fact about
> their development and not a fact about their worth.

and then names the failure:

> the game read gets converted into an altitude verdict… Each step feels like an inference.
> The last one is contempt with a diagram attached.

**That warning is about reading other people. The letter is about your own enrolment.** They
are different acts and the letter never crosses into the first one. The formulation that keeps
them apart is also the one that dissolves the depth allergy Wendell named:

> **the arrangement is a property of the curriculum, not of the student.** A school's entry
> requirement states what can be taught next. It does not state what anybody is.

Every altitude sentence in the letter is written to that rule. No colour vocabulary, no
student is ever placed on a scale, and the only ranking in the document ranks courses.

## Where it sits and what it fixes

Between ch2 and ch3, at the door of the six schools. Signed *the Headmaster*, never named, so
it is the same hand that files ch8's admissions page — a reader who hears the match has found
the reveal six chapters early and is right.

| problem | how the letter answers it |
|---|---|
| Depth's scale dial, absent | the scope clause: enrol at any depth, and the register does not distinguish |
| Visibility, absent, 0 hits | one clause: the roll is not published |
| `ch1:193`'s unkept promise | the letter prints the loop and ch1's pointer moves here |
| Jordan's *"I'm doing more harm than I know"* | the term ends with what the other person did staying theirs and not being recorded as her result |
| moralizing, her top drop-off trigger | the institution declines to be the authority on its own subject, in the closing paragraph |

---

# A LETTER TO THE NEWLY ENROLLED

You are enrolled. We put that in the first line rather than working up to it, on the reasoning
