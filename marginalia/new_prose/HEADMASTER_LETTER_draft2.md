# The Headmaster's Letter, draft 2

**2026-07-31.** Draft 1 was a policy document about the handbooks. Wendell: *"this feels like
a weird apology for the handbook rather than a breakdown of the hopes and intentions of the
school… very long, meandering and honestly some of the lowest quality writing in the book."*

**The root error, and it was traceable.** I raised first-person plural from 8.8 to 25 per 1k
on purpose, to match ch8's admissions page so the reveal would plant. A handbook is a form
filed by an institution; a letter is one person writing. Optimising for the plant broke the
genre, and once the letter was a *we* it could only talk about forms and procedures, because
an institution has no hopes.

## What the interview gave me

| question | his answer | what it changed |
|---|---|---|
| why does he write it | to orient a new student. The school is idiosyncratic enough that he worries people will not be set up for success. He wants them to know **he has taken their experience into account** and that **they can trust the process** | the letter's spine. Every paragraph now serves one of those two |
| what are the schools for | practicing the different dimensions of allyship. **Allyship happens inside different worldviews**, and teaching each worldview is how everyone gets what they need. They allow **comprehensiveness and specialization** | paragraph 2, and it is the thing draft 1 never said at all |
| who is he writing to | anyone who picks up the packet. *A dear, reader* | first person singular, direct address, salutation |
| glad or warning | **glad she is here and excited to see what she does.** Warnings exist, mostly positive | the warnings are two sentences near the end rather than the structure |
| does he like the job | **takes joy in it and believes in the work** | the closing, which is now the only unguarded thing in the letter |

## The plant, rebuilt on something better than pronouns

Draft 1 planted on *we* density, which is why it read as a committee. Orr's real signature is
a habit of mind: **he names the others, agrees inside their school, then qualifies**, and he
runs the longest sentences in the book. Draft 2 plants on those instead. *"Six of us instead of
one of me"* is the ambiguity his dial actually calls for, and it is a joke that is true, which
`HEAD_REGISTERS` marks as the only Head who gets those on purpose.

## What survives from draft 1

One line. The student who enrols in the expectation, because it came from watching students
rather than from a checklist. The fourth-year who is conspicuously worse at something the
first-year already does went with the paragraph it was defending, which was about the ordering
of the schools reading as a verdict on the student, and draft 2 does not need defending there.

**Cut entirely:** the disclaimer paragraph (defensive), the instructions on how to read the
