...
**Hexagram** — One of 64 I Ching trigram pairs that form the oracle card system. Each hexagram is a specific intersection of a gate (lower trigram) and a chapter's Face territory (upper trigram). The hexagram is not named in the book; it is felt. *[Ch1] — See also: Trigram, Oracle Card*

**Lake (Dui ☱)** — The I Ching trigram for Joy, Openness, What Meets. Upper trigram of Ch6 (Diplomat). Color: blue. *[Ch6] — See also: Trigram, Hexagram*
...
**Sky/Heaven (Qian ☰)** — The I Ching trigram for Creative Force, What Moves, What Acts. Upper trigram of Ch5 (Architect). Color: white. *[Ch5] — See also: Trigram, Hexagram*

**Thunder (Zhen ☳)** — The I Ching trigram for Arousal, Movement, What Rouses. Upper trigram of Ch3 (Challenger). Color: red. *[Ch3] — See also: Trigram, Hexagram*

**Trigram** — One of eight I Ching building blocks (Heaven/Sky, Earth, Thunder, Wind, Water, Lake, Mountain, Fire) that combine in pairs to form the 64 hexagrams. Each trigram has a name, a symbol, and a quality of movement. *[Ch1] — See also: Hexagram, Oracle Card*
...
**The 3-2-1** — A practice for clearing a gate's charge before it contaminates the next encounter. Name what arrived (3), what it's doing to you (2), what you're doing with it (1). Used when a gate is still running and you can't get clean. *[Ch2] — See also: Gate, Emotional Alchemy*
