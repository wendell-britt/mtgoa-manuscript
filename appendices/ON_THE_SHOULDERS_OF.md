...
*This book is a synthesis, not an invention. Where an idea here is load-bearing, it has a lineage — and you deserve to know where to read further if something resonated and you want the rigor underneath it. This isn't a complete bibliography; it's an honest map of which parts of the book are indebted to which sources, and what those sources offer a reader who wants to go deeper. I've only listed the work the book actually stands on — not every adjacent idea I admire.*
...
The "Try It Now" invitations in this book have a shape, and the shape is **Gerard Egan's**. *The Skilled Helper* is forty years of work on what skilled helping actually looks like as a reproducible practice rather than a set of good intentions: name the current picture, find the preferred picture, build the path between them. That's the invisible scaffolding under how this book teaches — and Egan's deeper insight, that the helper's presence is the primary instrument and that you create the conditions for someone to develop rather than doing their work for them, is the spine of the Sage chapter. If you want to go further on the craft of helping, this is the book.
