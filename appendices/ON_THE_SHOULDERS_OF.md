...
The "Try It Now" invitations in this book have a shape, and the shape is **Gerard Egan's**. *The Skilled Helper* is forty years of work on what skilled helping actually looks like as a reproducible practice rather than a set of good intentions: name the current picture, find the preferred picture, build the path between them. That's the invisible scaffolding under how I teach — and Egan's deeper insight, that the helper's presence is the primary instrument and that you create the conditions for someone to develop rather than doing their work for them, is the spine of the Sage chapter. If you want to go further on the craft of helping, this is the book.
...
weak ones — is **Donella Meadows'**. The term runs through the Architect chapter
as a term of art, and it is hers. *Thinking in Systems: A Primer* is the entry
point; the essay "Leverage Points: Places to Intervene in a System" is where the
ranking lives, and it repays rereading every few years. Meadows is also the
...
**Martin Seligman** is where *learned helplessness* comes from: the state that sets in after enough attempts that changed nothing, at which point a person stops trying even when trying would work. Chapter 1 uses it for what happens when the suffering that moves you is out of reach and the people in reach are the ones you try to fix instead. Chou explains what pulls a person back to a game; Seligman explains what makes them stop playing.
