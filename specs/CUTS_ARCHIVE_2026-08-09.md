# Cuts archive — the length cuts of 2026-08-09

**Every passage removed from the book by `PROPOSAL_CUTS_2026-08-09.md`, verbatim, in cut
order.** The book no longer carries these; the repo does, here, where a reader can find them
without git archaeology. Restoring one is a copy-paste plus a seam check.

---

## ch3 §3 — the anger template paragraph
...
## ch3 §3 — the sadness template paragraph
...
## ch3 §4 Grow — the This-might-look-like bullets
...
## ch3 §4 Show — the This-might-be bullets
