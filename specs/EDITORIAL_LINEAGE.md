...
| 2026-09-22 | A second panel (DL-110, `specs/PANEL_OPEN_DECISIONS_2026-09-22B.md`) checked whether the base's two-books condition — quoted below — was met now that MTGOA and Fear to Joy both run core v34. **It is: ruled, not merely recommended.** Phase 1 (create `wendell-britt/editorial-core`, add `core_repo:` to the manifest, tag the release) is ready to run, pending Wendell's word to create the repository. Q1 and Q2 below are unchanged. |
