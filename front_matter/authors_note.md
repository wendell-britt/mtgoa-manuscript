...
Rules arrived to protect that group, but they do not work. Be good. Do no harm. Use the current language. Follow the right people. Give until it costs you.

Every one of those is reaching for something real. Look at what they run on. Say the correct words and the situation is supposed to change; anywhere else we would call that magic. Whoever stands near the one handing out approval is safe. That is dominance wearing a better vocabulary.

The most useful idea I can hand you before chapter one is Ken Wilber's name for this confusion. He calls it the pre/trans fallacy. Two very different positions sit on either side of the conventional middle: one that has not reached the rules yet and one that has been through them and come out the far side. From inside the middle, the two look identical.

Harm reduction is where that costs the most. One person hands out clean needles and gets called an enabler. Another runs a session that leaves a whole team uncomfortable for a week and gets called harsh. One of them may be careless and one may be doing the only work that moves anybody, yet the rules cannot tell, because the only measure the rules have is whether somebody flinched. The magic and the dominance from a moment ago pass that same test, since both of them use the right words. So the rules defend in both directions at once, while the believer pays for the defense.
...
Training exists for this. Most of it does not take, though the failure is rarely the curriculum. People leave. A course has to survive your second month. Almost none of them do.

Allyship is already a game, one that is already gamified. Yu-kai Chou, who maps what actually drives people, separates the motivators that leave you feeling capable from the motivators that leave you anxious and compliant. Both get results. Scarcity, social pressure, and fear of losing your standing will absolutely make somebody act, but they will hollow that person out over about three years. Every drive currently powering allyship comes from that second set. The work is not the problem. The drives underneath it are.
...
What you cannot look at directly becomes visible the moment you meet it somewhere else, which is what the best fantasy has always been for. You are going to recognize your own week in a village you have never been to.
