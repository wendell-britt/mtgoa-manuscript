...
A live quest arrives as anticipation with some dread underneath it. For an Architect the dread is usually that the thing will be built worse without you, which is frequently true and is not a reason.
