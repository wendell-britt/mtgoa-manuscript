...
The Shaman's pair: your response to a situation and the move you make from it.

**Feeling** is noticing that a situation has affected you before deciding what it means. A comment follows you home. You realize you are no longer listening to a meeting the same way. You do not have to treat that response as proof. You do have to let it become a question.

**Function** is what becomes possible when you act on that question. You ask what no one has named. You name the pattern you can see. A decision changes because someone had words for what was happening. Function is whether your response gives the people in the situation something useful to do.

Both ends fail, and they fail unequally. Function without Feeling is the practitioner who knows the approved language, speaks at the right moment, and leaves the situation unchanged: competent, useful in a narrow band, unable to name what the people at the table have missed. Feeling without Function can look like depth. She has spent years noticing how situations work: a person stops offering ideas after being interrupted twice; an agreement moves forward that no one believes. She keeps those observations private. Nobody in the situation gains anything from her knowing.

This reader may be allowed to feel collectively but discouraged from trusting what they notice alone. The questions arrive quickly: Did I mistake this? Am I centering myself? Why should my account matter more than the group’s agreement? Function has warnings of its own, and this altitude issues them loudest: outcomes over people, results as the metric, the whole language of getting things done, which has done enormous work for people who never asked who was being spent. So one end of the axis is available only in its group form, and the other end sounds like the thing the altitude was built to leave behind.
...
**Joy completes into bliss.** Joy can be the hardest channel to stay with. When somebody is suffering, a moment of joy in this work can make you self-conscious: you are afraid of being seen enjoying yourself, as if delight proves you have missed the stakes. The move is to let what is good land without putting it on display, turning it into a performance, or using it to declare the work finished. What it restores is participation: you can take part in what is working while staying answerable to the harm that remains. You can tell you are there when the good part gives you energy for the next move instead of a reason to look away.

**Neutrality completes into peace.** When neutrality is dissatisfied, it can flatten into boredom or apathy: nothing seems worth choosing, and the whole field becomes something to stand outside. When it is satisfied, neutrality becomes peace—the stillness that can hold two true things at once without picking. The move is to widen until you can see the whole field, then rest there. What it restores is rest: *I can rest.* You can tell you are there when the situation can stay unresolved for a moment without you checking out or forcing it toward a side.
...
**1 · BE IT.** First person. You are the part. Speak as *I*, one paragraph, and say what you have to say about showing up as an ally.
...
A referee can pick up a second job nobody handed it. It stops refereeing the game you chose and starts judging one you didn't. It begins ruling on how you are allowed to *feel* about your allyship: a good ally feels guilty, it decides; a good ally does not get angry at the people she came to help; a good ally does not trust what she notices when the group sees it differently. That is a judge now, and it holds court in you.
...
It shows up in a single beat. Someone on your team pushes through a decision a part of you clocks as wrong. On the old standard, the Controller rules your objection inadmissible before you can speak (*probably just my stuff*), and you go along with the group. Refereeing the game you chose, it lets the objection onto the field and holds you to your own rule, and you say the one true sentence, *"Something here doesn't sit right with me. Can we slow down?"*, even while your nerve tells you to let it go. It is the same part, blowing the same whistle. Only one thing changed: whose rules it enforces.

*Bring one real moment the Controller ruled a feeling out of order before you could act on it, something you noticed and talked yourself out of with "probably just my stuff," or a move you didn't make until it could be perfect. Name the rule it was enforcing, and whose rule it was. Two minutes to capture it as a BAR.*

---

### How the Controller Rules You Out

The Controller does not block what you notice with a vague no. It blocks with a verdict about you, and it has six of them, the same six every time:

*I'm not good enough. I'm not ready. I don't belong. I'm insignificant. I'm not worthy. I'm not capable.*

These are the whistle-calls. When something true moves in a moment and a part of you feels it, the Controller does not argue that the feeling is wrong. It disqualifies the one who would name it. Who are you to say this: you're not ready, you don't belong, you're not good enough. What you noticed never reaches the field because the referee who would call it has been ruled ineligible. That is the mechanism. The six beliefs read like stray bad thoughts about yourself. They are the specific tool the Controller uses to keep your Shaman move from ever getting made.

This is why you do not beat them by arguing. Argue *I am good enough* and you have already accepted the court. Now you are litigating your own standing while the moment passes, and the judge already has every past ruling on file and infinite patience. It wins on points every time. The Shaman's move is to notice that a court is even sitting, catch the belief in the act of disqualifying what you noticed, and make the play anyway. Name the ruling. Name whose rule it is. Bring what you noticed onto the field with the belief still talking: *there it is, "not ready." Noted. Here is the true thing anyway.*
...
The move onto the field with the belief still talking is the hinge of the whole chapter, and the chapter's real axis: Feeling and Function. The first half was Feeling: the charge sensed cleanly. This half is Function: turning what you notice into a move that changes something. Feeling without Function is endless sensing, nothing done. So take the move out of the forest, where nothing costs you and no one is watching, and into the places allyship actually happens, where it counts. What you notice does nothing for the person you came to help until it leaves your body and changes what happens next. Here the Shaman stops sensing and starts doing.
...
Write yours in one line with four things in it: what you will do, who it reaches, by when, and what it costs you. *Say What Is Going Unsaid* becomes: **I will tell Dana what I noticed in Tuesday's meeting and not soften it, before Friday, and it will cost me her thinking I am difficult.** That is a quest. *I will be more aware of my impact* is not one; nobody can tell whether you did it, including you.
...
When a situation catches you, the Shaman asks you to notice your response before you explain it away. If charge is already running, start with WAVE. Then use the Five-Move Form to choose your next move.

A private response becomes useful when people can respond to it. Say what is going unsaid. Stay for the answer. Let other people add what you could not see. That is how a group gets something it can work with.

The Challenger begins when naming what is going unsaid is not enough. A line has been crossed. Can you say no and hold it long enough for it to matter?
