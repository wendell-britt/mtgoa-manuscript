...
The Protector stands at the threshold of a book about allyship because it decides where your attention and energy go. When it believes you are under threat, it directs both toward your own safety. That can keep you from noticing what another person needs.

Sometimes the Protector makes another person's safety feel identical to your own. The feeling can look like love. In allyship, it turns the other person into an extension of you, instead of someone with their own needs, choices, and risks. Standing with someone as someone separate requires enough safety that the Protector is not using all your attention to protect you.

When the Protector cannot keep harm out, it may absorb the impact so something else can keep going. That absorbed weight is the Damaged Self. You will meet it nearer the center.

You do not fight the Protector or force it aside. Before you respond, name what you believe is at risk. Then decide whether the moment calls for a boundary, a question, or your continued presence. Chapter 3 gives that sequence a name and a form.

In a meeting, the Protector may hear a challenge as an attack. You over-explain, defend your position, or wait for everyone else to make the ground feel safe. When the Protector can distinguish challenge from attack, you can say, "I'm open to challenge; I'm not available for personal attacks," and stay in the conversation.

*Bring one moment when the Protector took the joystick before you did. What did it think it was protecting? What was actually at risk? What response would have helped you stay present? Take two minutes to capture it as a BAR.*
...
Ask what this daemon is costing while it keeps driving: what it costs you, the people around you, and the person you're trying to help. The cost is your reason to take the joystick back, and saying it plainly takes the shine off the autopilot.
