...
That gap comes with an explanation attached, and the explanation is wrong. It says the problem is you: not committed enough, not brave enough, still too attached to being comfortable. You have carried some form of that for a while now, and it gets heavier with every book you finish.
