...
Yu-kai Chou spent a decade mapping what actually keeps a human being playing — what pulls people back to some things for years and drives them out of others for good. Games are engineered around the first kind of pull. Allyship, almost always, is built out of the second. So a game makes serious work go down easier, and that matters least: no other structure generates the energy to keep doing serious work for a lifetime instead of one burnout cycle.
