...
The deck starts earning its keep here. You have been handed twenty cards six times in this book: the Shaman's twenty, then the Challenger's, the Regent's, the Architect's, the Diplomat's, the Sage's. A hundred and twenty cards. Five moves crossed against four domains, six operations deep. Nobody built that as a reference table. It works as the practice surface. Every chapter has pointed at its own twenty.
...
The modes loop, each pass through going deeper. The deck outlasts any single trip through it.
...
One tell, which has nothing to do with how productive you feel, separates real building from the kind that's secretly avoidance. Direction gives it away: does the work move toward contact with someone, or away from it?
...
You now know the Five-Move Form. Wake up. Open up. Clean up. Grow up. Show up. Then you come back, which is what turns one pass into a practice.
...
**Example:** *I want to help people be better allies* is a topic. *People who have done the reading still default to their home face the moment something lands hard, with nowhere to practice the difference* is a problem. The second tells you what to build by Friday. Then cut once more, to whose problem: *the two friends who stopped saying anything true at dinner after the argument in March.* Now a stranger can repeat it back, and you know whose Friday you are building for.
...
**One.** A director says something in a team meeting that lands hard on the newest person at the table. It is not ambiguous and it is not deniable. The person goes still and says nothing while the meeting moves to the next agenda item in about four seconds. You have the standing to speak, though you are aware, while the four seconds are passing, that speaking will cost you something with the director.
